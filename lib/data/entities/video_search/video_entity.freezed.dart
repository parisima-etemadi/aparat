...
abstract class $VideoEntityCopyWith<$Res> {
  ...
  $Res call({String small_poster, String uid});
}
...
class _$_VideoEntity implements _VideoEntity {
  const _$_VideoEntity({required this.small_poster, required this.uid});
  ...
  @override
  String toString() {
    return 'VideoEntity(small_poster: $small_poster, uid: $uid)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(small_poster),
...
abstract class _VideoEntity implements VideoEntity {
  const factory _VideoEntity(
      {required final String small_poster,
      required final String uid}) = _$_VideoEntity;
